...
export default function NonAlcoholicBeersSection() {
  ...
  // Agrupar por precio
  const groupedByPrice = nonAlcoholicBeersMenu.reduce<Record<number, typeof nonAlcoholicBeersMenu>>((acc, item) => {
  ...
  return (
    <section id="sin-alcohol" className="py-16 md:py-24 bg-gray-900">
        ...
        <ScrollReveal>
          <div className="text-center mb-10 md:mb-14">
            ...
            <p className="text-gray-400 mt-3 max-w-xl mx-auto text-sm md:text-base">
              Todo el sabor de una buena cerveza, sin alcohol. Para disfrutar sin preocupaciones.
            </p>
          </div>
        </ScrollReveal>
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
          <ScrollReveal className="w-full lg:w-1/3 shrink-0">
            <div className="relative h-64 lg:h-96 rounded-xl overflow-hidden">
              <img
                src="https://readdy.ai/api/search-image?query=non%20alcoholic%20mexican%20beer%20bottles%20corona%20cero%20modelo%20especial%20zero%200.0%20alcohol%20free%20ice%20cold%20on%20dark%20bar%20counter%20condensation%20warm%20lighting%20restaurant%20photography%20dark%20moody&width=300&height=400&seq=sin-alcohol-group-v2&orientation=portrait"
                alt="Sin Alcohol"
                title="Cervezas sin alcohol en La Cabrona"
                loading="lazy"
                decoding="async"
                fetchpriority="low"
                width="400"
                ...
                <div className="mb-6 last:mb-0">
                  ...
                  <div className="bg-gray-800/50 rounded-xl border border-gray-700/50 overflow-hidden">
                    {group.items.map((item) => {
                      const outOfStock = isPaused(`na-${item.id}`);
                      const favId = 950 + item.id;
